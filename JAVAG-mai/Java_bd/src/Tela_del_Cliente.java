 ...
 * @author CAMARGO
 */
public class Tela_del_Cliente extends javax.swing.JFrame {


    public Tela_del_Cliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, -1, -1));
        ...
        getContentPane().add(alerta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 210, 220, 30));
    ...
    private void del_confirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_del_confirmaActionPerformed
        ...
        String[] funcionario = {"Clientes", metodoDel , pergunta_field.getText(),valores.metodo_busca};
