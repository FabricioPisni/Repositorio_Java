 ...
 * @author CAMARGO
 */
public class Tela_Pratos extends javax.swing.JFrame {
    ...
    public class valores {
        ...
        public static String tabela = "pratos";
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(botao_nome, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, -1, 29));
        ...
        getContentPane().add(text_info, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, -1, -1));
        ...
        getContentPane().add(botao_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, -1, -1));
    ...
    private void botao_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao_pesquisarActionPerformed
        ...
        if(pergunta_field.getText().equals("")) {
            ...
            Object[] resultado_pesquisa =  pesquisa_bd.pesquisar_tabela(Tela_Pratos.valores.metodo_busca, pergunta_field.getText(), Tela_Pratos.valores.tabela);

                if(Arrays.toString(resultado_pesquisa).equals("[notFound]")){
                    alerta.setText("Não achamos o prato");
                }else {
                    pergunta_field.setVisible(false);
                    botao_pesquisar.setVisible(false);
